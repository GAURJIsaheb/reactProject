...
export async function sendResetEmail({ to, userName }) {
  
  await transporter.sendMail({
    from: `"Placement Cell - CCSU" <${process.env.MAIL_USER}>`,
    to,
    subject: '🚀 Placement Drive: Newgen Software | 23rd April',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <style>
          ...
          .header h1 { margin: 0; color: white; font-size: 26px; font-weight: 800; }
          .header p { margin: 6px 0 0; color: rgba(255,255,255,0.75); font-size: 13px; }
          .body { padding: 36px 32px; }
          .body p { color: #a0a3b1; font-size: 15px; line-height: 1.7; margin: 0 0 16px; }
          .body strong { color: #e8eaf0; }
          .info-box { background: rgba(99,102,241,0.08); border: 1px solid rgba(99,102,241,0.3); border-radius: 12px; padding: 18px; margin-top: 20px; }
          .info-box p { margin: 6px 0; color: #c7c9d9; font-size: 14px; }
      ...
      <body>
        <div class="wrapper">
          ...
          <div class="body">
            <p>Hello <strong> aakanshapandey@gmail.com</strong>,</p>

            <p>We are pleased to inform you that a placement drive is being conducted for the <strong>BCA batch</strong> at <strong>Chaudhary Charan Singh University</strong>.</p>

            <div class="info-box">
              <p><strong>🏢 Company:</strong> <span class="highlight">Newgen Software</span></p>
              <p><strong>📅 Date:</strong> 23rd</p>
              <p><strong>📍 Venue:</strong> College Campus</p>
            </div>

            <div class="info-box">
              <p><strong>🕒 Round 1:</strong> Aptitude Test (11:00 AM)</p>
              <p><strong>💻 Round 2:</strong> DSA Coding Round (1:00 PM)</p>
            </div>

            <p>Please ensure that you are present on time and come prepared for both rounds. Carry all necessary documents.</p>

            <p><strong>HOD:</strong> Shamshad Ali</p>
          </div>

          <div class="footer">
            <p>Placement Cell · CCSU</p>
          </div>
